    ...
    <footer className="border-t bg-muted/30 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
        <div className="flex items-center gap-2">
          ...
          <span>— student service marketplace</span>
        </div>
        <nav className="flex gap-6">
          <Link to="/services" className="hover:text-foreground transition-colors">Browse</Link>
          <Link to="/auth/login" className="hover:text-foreground transition-colors">Login</Link>
          <Link to="/auth/register" className="hover:text-foreground transition-colors">Register</Link>
        </nav>
