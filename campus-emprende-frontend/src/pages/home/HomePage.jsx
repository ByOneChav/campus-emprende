...
// ⚠️ IMPORTANTE (usa esta ruta si @ no funciona)
  ...
  return (
    <div className="flex flex-col home-container">
      ...
      <section className="pt-32 pb-24 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6 glass hero-box">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {categories.map(({ icon: Icon, label, color }) => (
              <Link
                ...
                className="group"
              >
                <Card className="hover:border-primary/50 hover:shadow-sm transition-all cursor-pointer category-hover glass">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="flex flex-col items-center text-center gap-3 feature-item">
        ...
        <section className="py-20 px-4 bg-primary text-primary-foreground">
          <div className="max-w-2xl mx-auto text-center space-y-4">
            ...
            <p className="opacity-80">
              Únete a miles de estudiantes que compran y venden servicios en el campus.
            </p>
